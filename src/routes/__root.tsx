...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lotta Napoletana — Wood-fired pizza in Prishtinë" },
      { name: "description", content: "Neapolitan pizza in the heart of Prishtinë. Wood-fired dough, imported flour, and a chef who greets every table." },
      { property: "og:title", content: "Lotta Napoletana — Wood-fired pizza in Prishtinë" },
      { property: "og:description", content: "Neapolitan pizza in Prishtinë. Wood-fired, hand-stretched, five stars over a thousand times." },
